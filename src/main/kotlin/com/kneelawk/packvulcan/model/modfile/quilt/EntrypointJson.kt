...
object EntrypointSerializer : AdaptableSerializer<EntrypointJson>() {
    override val serialName = "com.kneelawk.packvulcan.model.modfile.quilt.EntrypointJson"
...
object EntrypointListSerializer : MaybeListWrapperSerializer<EntrypointListJson, EntrypointJson>() {
    ...
    override val descriptor = buildClassSerialDescriptor("com.kneelawk.packvulcan.model.modfile.quilt.EntrypointListJson") {
