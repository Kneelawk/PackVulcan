 ...
 *
 * A [LazyDropdownMenu] behaves similarly to a [Popup], and will use the position of the parent layout
 * to position itself on screen. Commonly a [LazyDropdownMenu] will be placed in a [Box] with a sibling
 * that will be used as the 'anchor'. Note that a [LazyDropdownMenu] by itself will not take up any
 * space in a layout, as the menu is displayed in a separate window, on top of other content.
 *
 * The [content] of a [LazyDropdownMenu] will typically be [DropdownMenuItem]s, as well as custom
 ...
 *
 * [LazyDropdownMenu] changes its positioning depending on the available space, always trying to be
...
fun LazyDropdownMenu(
    ...
    size: DpSize = DropdownMenuDefaultSize,
...
val DropdownMenuDefaultWidth = 280.dp
val DropdownMenuDefaultHeight = (48 * 6).dp
val DropdownMenuDefaultSize = DpSize(DropdownMenuDefaultWidth, DropdownMenuDefaultHeight)
